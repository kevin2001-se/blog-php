                    ...
                    <div class="container p-0">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="d-flex flex-column columna1">
                                ...
                                <figure class="p-2 m-0 photo1" vinculo="<?php echo $blog["dominio"].$categorias[0]["ruta_categoria"]; ?>" style="background-image: url(<?php echo $blog["dominio"]; ?><?php echo $categorias[0]["img_categoria"]; ?>) !important;">

                                    <p class="text-uppercase p-1 p-md-2 p-xl-1 small"><?php echo $categorias[0]["titulo_categoria"]; ?></p>

                                </figure>

                                <figure class="p-2 m-0 photo2" vinculo="<?php echo $blog["dominio"].$categorias[4]["ruta_categoria"]; ?>" style="background-image: url(<?php echo $blog["dominio"]; ?><?php echo $categorias[4]["img_categoria"]; ?>) !important;">
                            ...
                            <div class="d-flex flex-column flex-fill columna2">
                                ...
                                <div class="d-block d-md-flex">
                                    ...
                                    <figure class="p-2 m-0 flex-fill photo3" vinculo="<?php echo $blog["dominio"].$categorias[1]["ruta_categoria"]; ?>" style="background-image: url(<?php echo $blog["dominio"]; ?><?php echo $categorias[1]["img_categoria"]; ?>) !important;">

                                        <p class="text-uppercase p-1 p-md-2 p-xl-1 small"><?php echo $categorias[1]["titulo_categoria"]; ?></p>

                                    </figure>

                                    <figure class="p-2 m-0 flex-fill photo4" vinculo="<?php echo $blog["dominio"].$categorias[3]["ruta_categoria"]; ?>" style="background-image: url(<?php echo $blog["dominio"]; ?><?php echo $categorias[3]["img_categoria"]; ?>) !important;">
                                ...
                                <figure class="p-2 m-0 photo5" vinculo="<?php echo $blog["dominio"].$categorias[2]["ruta_categoria"]; ?>" style="background-image: url(<?php echo $blog["dominio"]; ?><?php echo $categorias[2]["img_categoria"]; ?>) !important;">
